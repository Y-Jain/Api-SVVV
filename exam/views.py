...
from exam.serializers import ProfileSerializer
...
def svvv_view(request):
    return render(request,'exam/svvv.html')
def aboutUs(request):
    return render(request,"exam/about.html")
def contact(request):
    return render(request,"exam/contact.html")
def blog(request):
    return render(request,"exam/blog.html")
def course(request):
    return render(request,'exam/course.html')
def post1(request):
    return render(request,'exam/post1.html')
def post2(request):
    return render(request,'exam/post2.html')
def post3(request):
    return render(request,'exam/post3.html')
def py(request):
    return render(request,"exam/py.html")
def lecture1(request):
    return render(request,'exam/lecture 1.html')
def lecture2(request):
    return render(request,'exam/lecture 2.html')
def lecture3(request):
    return render(request,'exam/lecture 3.html')
def lecture4(request):
    return render(request,'exam/lecture 4.html')
def lecture5(request):
    return render(request,'exam/lecture 5.html')
def lecture6(request):
    return render(request,'exam/lecture 6.html')
def lecture7(request):
    return render(request,'exam/lecture 7.html')
def logout(request):
